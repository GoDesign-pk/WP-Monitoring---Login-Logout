        ...
        <div class="see-panel-body">
            ...
            <div class="form-inline">
                <div class="footer-btns">
                    <a href="<?php echo admin_url("admin.php?page=actt_time_per_page&function=export_csv_per_page"); ?>" class="btn btn-warning pull-right <?php if ( !function_exists('activitytimepro_fms') || !activitytimepro_fms()->is_plan_or_trial('activitytimepropro') ) echo 'wal-pro'; ?>"><i class="fa fa-download"></i>&nbsp;&nbsp;<?php echo __('Export CSV','activitytime')?></a>
    ...
    $('#bulk_remove').click(function(){
        ...
        else
        {
            ...
            if(confirm('<?php echo_js(__('Are you sure?', 'activitytime')); ?>'))
            {
                ...
                // ajax to remove rows
                $.post('<?php menu_page_url( 'actt_time_per_page', true ); ?>&function=bulk_remove', { visited_pages_ids: ids }, function(data) {
